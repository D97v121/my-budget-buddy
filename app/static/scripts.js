...
console.log({
  leftInSpend,
  total_spend,
  money_lost_this_month,
  money_gained_this_month,
  totalSave,
  totalGive,
  totalInvest,
  spend,
  ...
  const config = {
    ...
    options: {
      ...
      plugins: {
        ...
        title: {
          display: true,
          text: 'Spend for the month' // This will show "Spend" as a title above the chart
        }
      }
    },
  };
  ...
  const config2 = {
    ...
    options: {
      ...
      plugins: {
        ...
        title: {
          display: true,
          text: 'Money Distribution for the month'
        }
      },
    },
  };
...
tagNames = tagNames;
  ...
  const data3 = {
    ...
    datasets: [{
    label: ' ',
    data: [Math.abs(money_lost_this_month), money_gained_this_month],
  ...
  const config3 = {
    ...
    options: {
      ...
      plugins: {
        ...
        title: {
          display: true,
          text: 'All transactions this month'
        }
      }
    },
  };
